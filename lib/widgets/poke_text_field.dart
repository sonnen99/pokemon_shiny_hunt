...
class PokeTextField extends StatelessWidget {
  ...
  const PokeTextField({super.key, required this.onChanged, required this.labelText, required this.textEditingController, required this.obscureText, required this.keyboardType});
